...
\textbf{Hvorfor komplementer?} ``Komplementer'' i økonomisk forstand betyr at tingene forsterker hverandre: marginalavkastningen av ett ben stiger med kvaliteten på de to andre. Bedre måling (S2) gjør sterkere insentiver (S3) mer effektive; bedre desentralisering (S1) gjør lokal måling viktigere. Konsekvens: å forbedre ett ben alene gir lite, men å forbedre alle tre samtidig gir mye mer enn summen. \emph{Misalignment} -- skjevhet mellom benene -- gir derimot raskt verditap:
...
\item \textbf{Tilpasningsproblem} (endrede omgivelser). Løses ved at arkitekturen tilpasses så lenge marginalgevinst (MR) overstiger marginalkostnad (MC). \emph{Economic Darwinism} (Alchian 1950): markedet ``selekterer'' bort firmaer som ikke tilpasser seg. Det er ikke nødvendig at hver leder forstår teorien -- de som tilfeldigvis har riktig arkitektur overlever, resten konkurreres ut. Konsekvens: observerte firmaformer er ikke nødvendigvis ``valgt'' bevisst, men de er likevel \emph{effektive} -- ellers hadde de vært borte.
\end{enumerate}
