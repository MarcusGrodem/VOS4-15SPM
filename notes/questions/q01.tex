...
De fem centertypene -- \emph{cost, expense, revenue, profit, investment} -- representerer en stige av delegert beslutningsrett der valget av centertype må følge controllability-prinsippet: målet skal dekke akkurat det lederen kan kontrollere, verken mer eller mindre. [SLIDE]
...
\begin{itemize}\setlength{\itemsep}{2pt}
\item \textbf{Tese:} Centertype = beslutningsrett + måltall + insentiv; valget følger controllability-prinsippet.
