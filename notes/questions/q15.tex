...
\emph{CARA-nytte} (\emph{Constant Absolute Risk Aversion}) er en standard nyttefunksjon der den absolutte risikoaversjonen er konstant -- altså agenten krever samme kronepremie for samme kronerisiko, uavhengig av formuesnivå. Med CARA blir indifferenskurvene i $(\sigma_W, E[W])$-rommet $E[W] = \bar{U} + \tfrac{r}{2}\sigma_W^2$ -- stigende og konvekse oppover. Intuitivt: jo høyere risiko ($\sigma_W$), jo høyere forventet lønn må til for å bevare samme nytte. Risikoavers agent ($r>0$): bratte kurver -- liten økning i risiko krever stor økning i forventet lønn. Risikonøytral ($r=0$): horisontale kurver -- agenten bryr seg bare om forventning. \emph{Certainty equivalent} (CE -- sikkerhetsekvivalent) er det \emph{sikre} beløpet som gir samme nytte som det usikre alternativet; geometrisk er det indifferenskurvens skjæring med $y$-aksen (der $\sigma = 0$). Risikopremien $RP = E[W] - CE = \tfrac{r}{2}\beta^2\sigma^2$ -- prinsipalen må betale dette ekstra for at agenten skal akseptere risikoen. Modellen visualiserer \thref{risk-sharing}{risikodeling}: prinsipalen tilbyr en kontrakt (et punkt i rommet); agenten aksepterer bare hvis nytten i punktet er minst lik \thref{reservation-utility}{reservation utility}. [SLIDE]
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\linewidth]{BSZ_kap_2_2026/by_slide/slide_006/BSZ_kap_2_2026_slide_006_asset_01_image5.jpeg}
  \caption{Rasjonelt valg mellom alternativ A og B -- nytteteorien i BSZ kap.\ 2: individer velger det alternativet som gir høyest nytte gitt budsjettbetingelsen. (BSZ kap.\ 2, slide 6) [SLIDE]}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\linewidth]{BSZ_kap_2_2026/by_slide/slide_005/BSZ_kap_2_2026_slide_005_asset_01_image4.png}
  \caption{Illustrasjon av opportunity cost: valg har konsekvenser -- velger man høy inntekt, kan man ``drukne'' i redusert integritet. (BSZ kap.\ 2, slide 5) [SLIDE]}
\end{figure}
