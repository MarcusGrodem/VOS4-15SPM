...
Fama \& Jensen (1983) deler enhver beslutning i fire trinn: \emph{Initiation, Ratification, Implementation, Monitoring}. \thref{decision-management-control}{Decision Management} = (1)+(3); \thref{decision-management-control}{Decision Control} = (2)+(4). Når beslutningstakeren \emph{ikke} er \thref{residual-claimants}{residual claimant}, bør Management og Control \emph{separeres} for å redusere opportunisme; dette er grunnsteinen i \thref{decision-rights-allocation}{allokeringen} av S1, og bryter særlig ned når store \thref{externalities}{eksternaliteter} eller agentkonflikter står i spill. [SLIDE]
...
Fama \& Jensens 4-trinns-modell formaliserer at beslutninger har en sekvens, og at \emph{rolledeling} mellom Management (1+3) og Control (2+4) reduserer opportunisme når beslutningstakeren ikke fanger fulle formueeffekter. Separasjonen institusjonaliseres typisk gjennom styre med ratifikasjons- og monitoreringsplikter, CAPEX-terskler, og uavhengige revisjonsutvalg. Modellen er normativ: separer når kostnaden ved opportunisme overstiger kostnaden ved Control-leddet. [SLIDE]
...
Den part som har krav på residualkontantstrømmen har sterkest insentiv til verdimaksimering. Når beslutningstaker \emph{er} residual claimant (gründer-eier, sole proprietor), trengs ingen separasjon -- agentkonflikten finnes ikke. Når hun \emph{ikke} er det (ansatt CEO, divisjonsleder), må Control utøves av et organ som representerer residualkravshaverne (styret). Residual claimant-status er derfor selve \emph{driveren} for om separasjon trengs. [SLIDE/BOK]
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.68\linewidth]{BSZ_kap_12_2026/by_slide/slide_014/BSZ_kap_12_2026_slide_014_asset_01_image4.png}
