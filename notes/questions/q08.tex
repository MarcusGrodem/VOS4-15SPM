...
Bedriften tiltrekker og holder på ansatte ved å tilby en kompensasjonspakke som minst når kandidatens \thref{reservation-utility}{reservation utility} ($U_0$), justert for \thref{compensating-differentials}{compensating differentials} der jobben har uattraktive trekk, og utnytter \thref{superior-assets}{superior assets} for å levere $U_0$ billigere enn konkurrenten. Pakken settes sammen av lønn $S$ og fringe $F$; optimalt mix bestemmes der ansattes indifferenskurve $U_0$ tangerer bedriftens isokostnadslinje (\thref{salary-fringe-benefits-mix}{salary--fringe-modellen}). [SLIDE]
...
Firmaspesifikke ressurser som lar bedriften levere én krone nytte til ansatt for mindre enn én krone kostnad: skattefavør på fringe, skalarabatt på forsikring, employer brand, kultur, internt arbeidsmarked, karrierevei, langsiktig eiermodell. Konsekvens: to bedrifter som konkurrerer om samme kandidat har ulik isokostnadslinje. Bedriften med superior asset når $U_0$ nærmere origo $\Rightarrow$ varig fordel. Tilsvarer en VRIN-ressurs (Barney) anvendt på arbeidsmarkedet. [SLIDE/BOK]

\paragraph{\thref{salary-fringe-benefits-mix}{Salary vs.\ fringe benefits-modellen}\quad\SThree}
Bedriften minimerer kostnad $C(S,F) = c_S S + c_F F$ under bibetingelsen $U(S,F) \geq U_0$. Optimum: $\mathrm{MRS}_{S,F} = c_S/c_F$ -- tangering mellom indifferenskurve og isokostnadslinje. Hvis $c_F < c_S$ (skatt, skala) tippes mixen mot $F$. Heterogene preferanser begrunner cafeteria-style benefits. Modellen er den \emph{prinsipielle håndteringen} spørsmålet ber om. [SLIDE/BOK]
