...
\begin{tikzpicture}[>=latex, every node/.style={font=\small}]
  ...
  % β*-markering (min av Total: d/dβ[4.2e^(-0.55β)+0.085β²]=0 ⇒ β*≈2.85, Total≈1.57)
  \draw[dashed, gray] (2.85,0) -- (2.85,1.57);
  \filldraw[green!50!black] (2.85,1.57) circle (2pt);
  \node[below, font=\bfseries\footnotesize] at (2.85,-0.05) {$\beta^*$};
\end{tikzpicture}
