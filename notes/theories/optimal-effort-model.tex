...
\begin{tikzpicture}[>=latex,scale=1.0]
  ...
  \draw[thick,red,domain=0:5.5,samples=60]
    plot (\x,{0.35*\x*\x}) node[right] {\small $MC(\beta)$ -- risikopremie};
  % Krysning: MB(2.85)≈2.85, MC(2.85)=0.35·8.12≈2.84
  \filldraw (2.85,2.85) circle (1.6pt);
  \draw[dashed] (2.85,0) -- (2.85,2.85);
  \node[below] at (2.85,0) {\small $\beta^{*}$};
\end{tikzpicture}
