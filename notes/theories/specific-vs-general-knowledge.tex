...
\item \textbf{Modellen sier ikke hvor mye desentralisering som er optimalt.} Den må kombineres med \thref{centralization-decentralization}{decentraliseringsmodellen} (Q06) som balanserer benefits/costs av desentralisering.
